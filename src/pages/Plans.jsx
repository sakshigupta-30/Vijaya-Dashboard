...
export default function Upgrade() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black flex flex-col items-center py-16 px-4 text-white">
      <h1 className="text-4xl font-bold mb-4 text-purple-400">Choose Your Plan</h1>
        ...
        {plans.map((plan) => (
          <div
            ...
            className={`border rounded-2xl p-8 shadow-lg flex flex-col justify-between transform hover:scale-105 transition-transform duration-300
              ${plan.popular ? "border-purple-500 bg-gray-800" : "border-gray-700 bg-gray-900"}
            `}
          >
            {plan.popular && (
              <div className="bg-purple-500 text-white text-xs uppercase px-3 py-1 rounded-full mb-4 w-max">
                Most Popular
              </div>
            )}
            <h2 className="text-2xl font-semibold mb-4 text-purple-400">{plan.name}</h2>
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl text-white font-semibold transition-colors duration-200
                ${plan.popular ? "bg-purple-500 hover:bg-purple-600" : "bg-gray-700 hover:bg-gray-800"}
              `}
            >
